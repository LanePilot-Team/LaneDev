...
export function buildStyle(): StyleSpecification {
  return {
    ...
    sources: {
      'taiwan-ocean': {
        type: 'geojson',
        data: asset('/data/environment/taiwan_ocean.geojson'),
        attribution: 'Made with Natural Earth',
      },
      'nanzih-green-areas': {
        type: 'geojson',
        data: asset('/data/environment/nanzih_green_areas.geojson'),
        attribution: '© OpenStreetMap contributors',
      },
      'nanzih-water-areas': {
        type: 'geojson',
        data: asset('/data/environment/nanzih_water_areas.geojson'),
        attribution: '© OpenStreetMap contributors',
      },
      'nanzih-waterways': {
        type: 'geojson',
        data: asset('/data/environment/nanzih_waterways.geojson'),
        attribution: '© OpenStreetMap contributors',
      },
