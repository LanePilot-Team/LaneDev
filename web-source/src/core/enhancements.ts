 ...
 */
function queueJournalPersistence(_journal: EnhancementRecord[]) {
  throw new Error('App 不允許修改道路資料')
}

export function loadJournal(): EnhancementRecord[] { return staticJournal() }
